...
onMounted(() => {
    ...
    /* Начало импорт АПИ*/
    fetch('https://new.joie.com.ua/api/get-page-seo')
...
<template>
    ...
    <div>
        ...
        <div class="home-banner small" id="top-block">
            ...
            <h2>
                <template v-if="lang === 'ua'">SEO<br>ПРОСУВАННЯ</template>
                <template v-if="lang === 'ru'">SEO<br>ПРОДВИЖЕНИЕ </template>
                <template v-if="lang === 'en'">SEO<br>PROMOTION</template>
            </h2>
