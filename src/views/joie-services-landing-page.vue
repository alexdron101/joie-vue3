...
onMounted(() => {
    ...
    /* Начало импорт АПИ*/
    fetch('https://new.joie.com.ua/api/get-page-landing')
        .then(response => response.json())
        .then(data => {
            let formatedData = {};
            data.forEach(it => {
...
<template>
    ...
    <div>
        ...
        <div class="home-banner small" id="top-block">
            ...
            <h2>
                <template v-if="lang === 'ua'">РОЗРОБКА <br>Landing page</template>
                <template v-if="lang === 'ru'">РАЗРАБОТКА <br>Landing page</template>
                <template v-if="lang === 'en'">WEBSITE <br>Landing page</template>
            </h2>
        ...
        <section id="sect1" class="">
            ...
            <div id="our-sites" class="raz-saita">
            ...
            <div id="about-us">
                ...
                <div>
                    ...
                    <span class="wow fadeInUp" data-wow-delay="1.0s">
