...
<template>
  ...
  <div>
    ...
    <div class="home-banner small" id="top-block">
            ...
            <h2>
                <template v-if="lang === 'ua'">РЕАЛЬНІ<br>ВІДГУКИ З GOOGLE</template>
                <template v-if="lang === 'ru'">РЕАЛЬНЫЕ<br>ОТЗЫВЫ С GOOGLE</template>
                <template v-if="lang === 'en'">REAL<br>REVIEWS FROM GOOGLE</template>
            </h2>
            <div class="span">
